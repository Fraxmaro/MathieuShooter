# app/animation.py
# pygame est un ensemble (module) de programmes qui nous aide a creer un jeu dans le language python
# on en a besoin dans ce programme, donc on l'importe comme ceci:
import pygame
